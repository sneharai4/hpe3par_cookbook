...
include HPE3PAR::RestHelper
 ...
 # validations
   ...
   op_status = create_vlun(new_resource.storage_system, new_resource.volume_name,
...
action :export_volume_to_hostset do
  ...
  op_status = create_vlun(new_resource.storage_system, new_resource.volume_name, new_resource.lunid, new_resource.hostset_name,new_resource.node_val, new_resource.slot, new_resource.card_port, new_resource.autolun)
  new_resource.updated_by_last_action(true) if op_status
end
...
action :export_volumeset_to_host do
  ...
  op_status = create_vlun(new_resource.storage_system, new_resource.volumeset_name, new_resource.lunid, new_resource.host_name, new_resource.node_val, new_resource.slot, new_resource.card_port, new_resource.autolun)
  new_resource.updated_by_last_action(true) if op_status
end
...
action :export_volumeset_to_hostset do
  ...
  op_status = create_vlun(new_resource.storage_system, new_resource.volumeset_name, new_resource.lunid, new_resource.hostset_name,  new_resource.node_val, new_resource.slot, new_resource.card_port, new_resource.autolun)
  new_resource.updated_by_last_action(true) if op_status
end
 ...
 action :unexport_volume_to_host do
  ...
  op_status = delete_vlun(new_resource.storage_system, new_resource.volume_name, new_resource.lunid, new_resource.host_name, new_resource.node_val, new_resource.slot, new_resource.card_port)
  new_resource.updated_by_last_action(true) if op_status
 end
...
action :unexport_volume_to_hostset do
  ...
  op_status = delete_vlun(new_resource.storage_system, new_resource.volume_name, new_resource.lunid, new_resource.hostset_name)
  new_resource.updated_by_last_action(true) if op_status
end
...
action :unexport_volumeset_to_host do
  ...
  op_status = delete_vlun(new_resource.storage_system, new_resource.volumeset_name, new_resource.lunid, new_resource.host_name, new_resource.node_val, new_resource.slot, new_resource.card_port)
  new_resource.updated_by_last_action(true) if op_status
end
...
action :unexport_volumeset_to_hostset do
  ...
  op_status = delete_vlun(new_resource.storage_system, new_resource.volumeset_name, new_resource.lunid, new_resource.hostset_name)
  new_resource.updated_by_last_action(true) if op_status
end